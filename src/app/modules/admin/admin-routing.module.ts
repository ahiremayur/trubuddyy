...
const routes: Routes = [
  {
    path: '',component:AdminDashboardComponent, children:[
      ...
      {path:'eightTOnine', component: EightTonineComponent},
      {path:'tenTOtwelth', component: TenTotwelthComponent},
      {path:'graduates', component: GraduatesComponent},
      {path:'professional', component: ProfessionalComponent},
      {path:'parent', component: ParentComponent},
      {path:'HowItWorks', component: HowItWorksComponent},
      {path:'person/:id', component: MentorInfoComponent},
      {path:'Contact', component: ContactComponent},
      {path:'About', component: AboutComponent},
      {path:'FAQ', component: FaqComponent},
      {path: 'book/:id', component: BookingSessionComponent},
      {path: 'mentee_dashboard', component: MenteeDashboardComponent},
      {path: 'mentor_dashboard', component: MentorDashboardComponent},
      {path: 'my-profile', component:MyProfileComponent},
      {path: 'job_education_form', component:JobEducationFormComponent},
      {path: 'personal_info_form', component:PersonalInfoFormComponent},
      {path: 'testing', component:TestingComponent},
      {path: 'checkbox', component:CheckboxComponent},
      {path: 'become_mentor', component:BecomeMentorComponent},
